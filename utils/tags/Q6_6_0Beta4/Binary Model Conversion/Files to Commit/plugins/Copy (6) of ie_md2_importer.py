...
def animate_md2(md2, mdl_component): # The Frames Group is made here & added to the mdl_component.
    ...
    for i in xrange(0, md2.num_frames): # Changing it to '0' will show the 1st frames name & vertexes.
     ...
     #   print md2.frames[i].name, type(md2.frames[i].name)
      ...
      #      print "mesh",mesh
         ...
         #   mesh.verts[j].co[2]=z
        frame['Vertices'] = mesh
        testframe['Vertices'] = mesh
        framesgroup.appenditem(frame)
        mdlframes[md2.frames[i].name + ':mf'] = testframe
 ...
 #   o.write("\nFrames:fg Data = " + str(xrange(0,md2.num_frames)) + " md2.num_frames\n" + str(mdl_component) + "\n")
    return mdl_component, framesgroup
...
def load_md2(md2_filename):
 ...
 #   mesh.hasFaceUV(1)  #turn on face UV coordinates for this mesh
  ...
  #  o.write("\nUV Data = " + str(xrange(0,md2.num_tex_coords)) + " md2.num_tex_coords\n" + str(uv_list) + "\n")
    ...
    def int2hex(n):
        "Returns the hexadecimal representation, as a 'string', of integer n."
        hex = chr(0)+"%X" % n
        return hex
    ...
    for i in xrange(0,md2.num_faces):
        vtx0 = int2hex(md2.faces[i].vertex_index[0])
        vtx0u = int2hex(md2.tex_coords[md2.faces[i].texture_index[0]].u)
        vtx0v = int2hex(md2.tex_coords[md2.faces[i].texture_index[0]].v)
        testTris = testTris + vtx0 + vtx0u + vtx0v
        vtx1 = int2hex(md2.faces[i].vertex_index[1])
        vtx1u = int2hex(md2.tex_coords[md2.faces[i].texture_index[1]].u)
        vtx1v = int2hex(md2.tex_coords[md2.faces[i].texture_index[1]].v)
        testTris = testTris + vtx1 + vtx1u + vtx1v
        vtx2 = int2hex(md2.faces[i].vertex_index[2])
        vtx2u = int2hex(md2.tex_coords[md2.faces[i].texture_index[2]].u)
        vtx2v = int2hex(md2.tex_coords[md2.faces[i].texture_index[2]].v)
        testTris = testTris + vtx2 + vtx2u + vtx2v
 ...
 #   o.write("1st 3 sets = vertexes, last set = face uv coords\n" + str(faces) + "\n")
    ...
    mdl_component, framesgroup = animate_md2(md2, mdl_component) # Calls here to make the Frames Group.
#     print "at line 500 mdl_component after 'Frames:fg' is added",mdl_component
    return testTris, mdl_component, skinsize, component_triangles, skingroup, framesgroup
...
def import_md2_model(md2_filename):
 ...
 #   try:
    testTris, TestComponent['ImpComponent 1:mc'], TestComponent['skinsize'], TestComponent['Tris'], skingroup, framesgroup = load_md2(md2_filename)
    Component = quarkx.newobj('ImpComponent 1:mc')
    Component.appenditem(skingroup)
    Component.appenditem(framesgroup)
    Component['skinsize'] = TestComponent['skinsize']
    Component['Tris'] = testTris # May have a problem here because it's in text not binary.
 ...
 #   o.write("TestComponent['Tris']")
 #   o.write('\n')
 #   o.write(str(TestComponent['Tris']))
 #   o.write('\n')
 #   o.write('\n')
 #   o.write('\n')
 #   o.write(testTris)
 ...
 #   o.write('\n')
    ...
    o.write('\n')
    o.write("ModelRoot.name")
    o.write('\n')
    o.write(str(ModelRoot.name))
    o.write('\n')
    o.write("ModelRoot.subitems")
    o.write('\n')
    o.write(str(ModelRoot.subitems))
    o.write('\n')
    o.write("ModelRoot.dictitems")
    o.write('\n')
    o.write(str(ModelRoot.dictitems))
    o.write('\n')
    o.write("ModelRoot.dictitems['ImpComponent 1:mc'].dictitems")
    o.write('\n')
    o.write(str(ModelRoot.dictitems['ImpComponent 1:mc'].dictitems))
    o.write('\n')
    o.write("ModelRoot.dictitems['ImpComponent 1:mc'].dictspec")
    o.write('\n')
    o.write(str(ModelRoot.dictitems['ImpComponent 1:mc'].dictspec))
    o.write('\n')
    o.write('\n')
    o.write(str(ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Skins:sg'].name))
    o.write('\n')
    o.write(str(ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Skins:sg']))
    o.write('\n')
    o.write(str(ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Skins:sg'].dictitems))
    o.write('\n')
    for skin in ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Skins:sg'].dictitems:
        o.write(str(skin))
        o.write('\n')
    o.write('\n')
    for skin in ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Skins:sg'].dictitems:
        o.write(str(ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Skins:sg'].dictitems[skin].dictspec))
        o.write('\n')
    o.write('\n')
 #   for Frame in ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Frames:fg'].dictitems:
    for Frame in ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Frames:fg'].subitems:
        o.write(str(Frame.name) + "  " + str(Frame))
        o.write('\n')
    o.write('\n')
  #  for Frame in ModelRoot.dictitems['Component 1:mc'].dictitems['Frames:fg'].dictitems:
      #  o.write(str(ModelRoot.dictitems['Component 1:mc'].dictitems['Frames:fg'].dictitems[Frame].dictspec))
    for Frame in ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Frames:fg'].dictitems:
        o.write(str(Frame) + "  no. of Vertices = " + str(len(ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Frames:fg'].dictitems[Frame].dictspec['Vertices'])))
        o.write('\n')
        o.write(str(ModelRoot.dictitems['ImpComponent 1:mc'].dictitems['Frames:fg'].dictitems[Frame].dictspec))
        o.write('\n')
        o.write('\n')
        o.write('\n')
    o.write('\n')
...
def loadmodel(root, filename, gamename, nomessage=0):
    ...
    ModelRoot, Component = import_md2_model(filename)
  #  return model
 #   import quarkpy.mdleditor
 #   editor = quarkpy.mdleditor.mdleditor
 #   editor.Root.appenditem(Component)
  #  editor.Root = ModelRoot
