...
def runimporter(m):
    print "in runimporter m is",m
    print "text",m.text
    print "onclick",m.onclick
    from qmacro import mdlfn
    mdlf = mdlfn[m.text]
    print "mdlf",mdlf
 ...
 #   print "Root",editor.Root

def runexporter(m):
    print "in runexporter m is",m
    print "text",m.text
    print "onclick",m.onclick
...
def BuildMenuBar(editor):
    ...
    def modelimporters():
        ...
        from qmacro import mdlfn
        mdlimportmenu = []
        for menuitem in mdlfn:
            print "menuitem",menuitem, type(menuitem)
            mdlimportmenu = mdlimportmenu + [qmenu.item(menuitem, runimporter, "load an "+str(menuitem))] 
        print "mdlfn",mdlfn
        print ""
        print "mdlimportmenu",mdlimportmenu
