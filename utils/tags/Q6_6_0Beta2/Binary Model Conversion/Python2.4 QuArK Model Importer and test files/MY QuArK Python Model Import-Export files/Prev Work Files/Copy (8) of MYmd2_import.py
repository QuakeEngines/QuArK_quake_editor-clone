...
class md2_skin:
    ...
    def load (self, file):
        # file is the model file & full path, ex: c:\Python24\models\chastity\tris.md2
        # temp_data is just the skin texture path and name, ex: models/chastity/anarchy.pcx
 ...
 #   o = open("c:\\Python24\\Md2_Model_Import_Data.txt", "w")
  ...
  #  mesh = NMesh.New()
    ...
    #    mesh.verts.append(vertex)
        mesh.append(vertex)
    o.write("Mesh Vertexes Data = " + str(xrange(0,md2.num_vertices)) + " md2.num_vertices\n" + str(mesh) + "\n")
