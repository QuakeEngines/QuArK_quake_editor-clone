...
def load_textures(md2):
    ...
    if int(md2.num_skins) > 0:
        ...
        #    imagecopy = file.read()
            ...
            skins[md2.skins[i].name] = imagecopy # Used for QuArK.
    ...
    #        o.write(Skin)
        ...
        return skins, skinsize # Used for QuArK.
    else:
        return skins, skinsize # Used for QuArK.
...
def load_md2(md2_filename):
 ...
 #       o.write(Header)
  ...
  #  mesh = NMesh.New()
    ...
    mdl_component['Skins:sg'], skinsize = load_textures(md2) # Calls here to make the Skins Group.
...
#     print "at line 500 mdl_component after 'Frames:fg' is added",mdl_component
    return mdl_component, skinsize, component_triangles
...
def import_md2_model(md2_filename):
    ...
    ### Different models for testing purposes.
    # md2_filename = "c:\\Python24\\models\\alien\\tris.md2"
    md2_filename = "c:\\Python24\\models\\chastity\\tris.md2"
    # md2_filename = "c:\\Python24\\models\\characters\\autopsy.md3"

    ModelRoot = {}
    Component = {}
    try:
        Component['Component 1:mc'], Component['skinsize'], Component['Tris'] = load_md2(md2_filename)
        Component['show'] = '\x01'
      #  print "skinsize",Component['skinsize']
      #  print "component_triangles"
      #  print component_triangles
    except:
        Component['Component 1:mc'] = load_md2(md2_filename)
        if Component['Component 1:mc'] is None:
            print "THE BUCK STOPS HERE !"

    ### Use the 'ModelRoot' below to drop into QuArK's Model Editor.
    ModelRoot['Model:mr'] = Component
...
def loadmodel(root, filename, gamename, nomessage=0):
    ...
    pass # here just for org setup, remove when done making this importer.
  #  return root

### To register this Python plugin and put it on the importers menu.
import quarkpy.qmdlbase
quarkpy.qmdlbase.RegisterMdlImportExporter(".md2 Importer", ".md2 file", "*.md2", loadmodel)
