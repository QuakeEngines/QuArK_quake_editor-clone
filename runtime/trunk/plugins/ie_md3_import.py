    ...
    #        print "u, v", surface.uv[i].u, surface.uv[i].v
        ...
        for face in faces:
            ...
            for vert_index in face:
                ...
                v = (TexHeight * surface.uv[vert_index].v) - TexHeight
                            ...
                            if tagsgroup[tag].name.find("head") != -1 and editor_dictitems[key].name.find("head") != -1:
                                ...
                                for frame in range(len(tag_subitems)):
                                    ...
                                    for vtx in comp_frame.vertices:
                                        # To try and rotate head components properly when they come through.
                                        comp_rotation = vector_by_matrix(vtx.tuple, mt)
                                ...
                                pass # We need to figure out what to do here.
                                break
