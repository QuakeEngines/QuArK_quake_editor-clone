...
class DisplayBar(ToolBar):
    ...
    def buildbuttons(self, layout):
        ...
        Btn3D = qtoolbar.button(layout.new3Dwindow, "new 3D window||New 3D-window  will create a new floating 3D-window, which you can place anywhere on your desktop.\nIt only exist as long as you are in the map editor.", ico_maped, 20)

        BtnFull3D = qtoolbar.button(layout.full3Dclick, "full 3D view||Full 3D-view  will take you to a full-screen 3D-display.\nYou must press Escape to return to the map editor.", ico_maped, 21)
        BtnOpenGL = qtoolbar.button(layout.toggleOpenGLwindow, "OpenGL 3D view||OpenGL 3D-view  will create a new floating OpenGL 3D-window, where you will be able to preview your light effects.", ico_maped, 27)
