...
namespace VTFEdit
{
	...
	public:
		...
		static bool CreateResources(CVTFOptions *Options, VTFLib::CVTFFile *VTFFile)
		{
			bool bResult = true;
			...
			if(Options->CreateLODControlResource)
			{
				...
				bResult &= VTFFile->SetResourceData(VTF_RSRC_TEXTURE_LOD_SETTINGS, sizeof(SVTFTextureLODControlResource), &LODControlResource) != vlFalse;
			}
