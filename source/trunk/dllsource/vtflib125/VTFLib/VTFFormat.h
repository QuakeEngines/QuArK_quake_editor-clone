...
// VTF version numbers (current version is 7.2)
//---------------------------------------------
#define VTF_MAJOR_VERSION	7		//!< VTF major version number
#define VTF_MINOR_VERSION	2		//!< VTF minor version number
...
typedef struct SVTFHeader_72_A SVTFHeader;
