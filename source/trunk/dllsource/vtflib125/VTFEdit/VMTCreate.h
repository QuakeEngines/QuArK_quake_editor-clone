...
namespace VTFEdit
{
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->btnNormalTexture->Click += new System::EventHandler(this, btnNormalTexture_Click);
			// 
			// txtNormalTexture
			// 
			...
			this->txtNormalTexture->Leave += new System::EventHandler(this, txtTexture_Leave);
			// 
			// lblNormalTexture
			// 
			...
			this->btnDuDvTexture->Click += new System::EventHandler(this, btnDuDvTexture_Click);
			// 
			// txtDuDvTexture
			// 
			...
			this->txtDuDvTexture->Leave += new System::EventHandler(this, txtTexture_Leave);
			// 
			// lblDuDvTexture
			// 
			...
			this->btnBumpTexture2->Click += new System::EventHandler(this, btnBumpTexture2_Click);
			// 
			// txtBumpTexture2
			// 
			...
			this->txtBumpTexture2->Leave += new System::EventHandler(this, txtTexture_Leave);
			// 
			// lblBumpTexture2
			// 
			...
			this->btnBaseTexture2->Click += new System::EventHandler(this, btnBaseTexture2_Click);
			// 
			// txtBaseTexture2
			// 
			...
			this->txtBaseTexture2->Leave += new System::EventHandler(this, txtTexture_Leave);
			// 
			// lblBaseTexture2
			// 
			...
			this->btnToolTexture->Click += new System::EventHandler(this, btnToolTexture_Click);
			// 
			// txtToolTexture
			// 
			...
			this->txtToolTexture->Leave += new System::EventHandler(this, txtTexture_Leave);
			// 
			// lblToolTexture
			// 
			...
			this->btnDetailTexture->Click += new System::EventHandler(this, btnDetailTexture_Click);
			// 
			// txtDetailTexture
			// 
			...
			this->txtDetailTexture->Leave += new System::EventHandler(this, txtTexture_Leave);
			// 
			// lblDetailTexture
			// 
			...
			this->btnEnviromentMaskTexture->Click += new System::EventHandler(this, btnEnviromentMaskTexture_Click);
			// 
			...
			this->txtEnviromentMaskTexture->Leave += new System::EventHandler(this, txtTexture_Leave);
			// 
			...
			this->btnEnviromentTexture->Click += new System::EventHandler(this, btnEnviromentTexture_Click);
			// 
			...
			this->txtEnviromentTexture->Leave += new System::EventHandler(this, txtTexture_Leave);
			// 
			...
			this->btnBumpTexture1->Click += new System::EventHandler(this, btnBumpTexture1_Click);
			// 
			// txtBumpTexture1
			// 
			...
			this->txtBumpTexture1->Leave += new System::EventHandler(this, txtTexture_Leave);
			// 
			// lblBumpTexture1
			// 
			...
			this->btnBaseTexture1->Click += new System::EventHandler(this, btnBaseTexture1_Click);
			// 
			// txtBaseTexture1
			// 
			...
			this->txtBaseTexture1->TextChanged += new System::EventHandler(this, txtBaseTexture1_TextChanged);
			this->txtBaseTexture1->Leave += new System::EventHandler(this, txtTexture_Leave);
			// 
			// lblBaseTexture1
			// 
			...
			this->cboShader->TextChanged += new System::EventHandler(this, cboShader_TextChanged);
			// 
			// lblShader
			// 
