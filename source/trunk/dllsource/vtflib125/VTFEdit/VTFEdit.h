...
namespace VTFEdit
{
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->btnChannelRGB->Click += new System::EventHandler(this, btnChannel_Click);
			// 
			// btnChannelR
			// 
			...
			this->btnChannelR->Click += new System::EventHandler(this, btnChannel_Click);
			// 
			// btnChannelG
			// 
			...
			this->btnChannelG->Click += new System::EventHandler(this, btnChannel_Click);
			// 
			// btnChannelB
			// 
			...
			this->btnChannelB->Click += new System::EventHandler(this, btnChannel_Click);
			// 
			// btnChannelA
			// 
			...
			this->btnChannelA->Click += new System::EventHandler(this, btnChannel_Click);
			// 
			// btnMask
			// 
			...
			this->btnCreateVMTFile->Click += new System::EventHandler(this, btnCreateVMTFile_Click);
			// 
			// btnConvertFolder
			// 
			...
			this->btnConvertWADFile->Click += new System::EventHandler(this, btnConvertWADFile_Click);
			// 
			// btnOptionsMenu
			// 
			...
			this->btnAutoCreateVMTFile->Click += new System::EventHandler(this, btnAutoCreateVMTFile_Click);
			// 
			// btnOptionsSpace1
			// 
			...
			this->btnFileMapping->Click += new System::EventHandler(this, btnFileMapping_Click);
			// 
			// btnVolatileAccess
			// 
			this->btnVolatileAccess->Index = 3;
			this->btnVolatileAccess->Text = S"&Volatile Access";
			this->btnVolatileAccess->Click += new System::EventHandler(this, btnVolatileAccess_Click);
			// 
			// btnHelpMenu
			// 
			...
			this->pnlSidebar->Size = System::Drawing::Size(216, 535);
			...
			this->tabSidebar->Size = System::Drawing::Size(200, 516);
			...
			this->tabFileSystem->Size = System::Drawing::Size(192, 490);
			...
			this->grpGoto->Size = System::Drawing::Size(176, 48);
			...
			this->cboGoto->Size = System::Drawing::Size(160, 21);
			...
			this->mnuGoto->Popup += new System::EventHandler(this, mnuGoto_Popup);
			// 
			// btnGotoRemove
			// 
			this->btnGotoRemove->Index = 0;
			this->btnGotoRemove->Text = S"&Remove";
			this->btnGotoRemove->Click += new System::EventHandler(this, btnGotoRemove_Click);
			// 
			// btnGotoClear
			// 
			this->btnGotoClear->Index = 1;
			this->btnGotoClear->Text = S"&Clear";
			this->btnGotoClear->Click += new System::EventHandler(this, btnGotoClear_Click);
			// 
			// grpFileSystem
			// 
			...
			this->grpFileSystem->Size = System::Drawing::Size(176, 416);
			...
			this->treFileSystem->Size = System::Drawing::Size(160, 392);
			this->treFileSystem->TabIndex = 0;
			this->treFileSystem->MouseDown += new System::Windows::Forms::MouseEventHandler(this, treFileSystem_MouseDown);
			this->treFileSystem->AfterExpand += new System::Windows::Forms::TreeViewEventHandler(this, treFileSystem_AfterExpand);
			this->treFileSystem->AfterCollapse += new System::Windows::Forms::TreeViewEventHandler(this, treFileSystem_AfterCollapse);
			this->treFileSystem->DoubleClick += new System::EventHandler(this, treFileSystem_DoubleClick);
			this->treFileSystem->BeforeExpand += new System::Windows::Forms::TreeViewCancelEventHandler(this, treFileSystem_BeforeExpand);
			// 
			// mnuFileSystem
			// 
			...
			this->mnuFileSystem->Popup += new System::EventHandler(this, mnuFileSystem_Popup);
			// 
			// btnFileSystemOpen
			// 
			...
			this->btnFileSystemOpen->Click += new System::EventHandler(this, btnFileSystemOpen_Click);
			// 
			...
			this->btnFileSystemShellExecute->Click += new System::EventHandler(this, btnFileSystemShellExecute_Click);
			// 
			...
			this->btnFileSystemExtract->Click += new System::EventHandler(this, btnFileSystemExtract_Click);
			// 
			...
			this->btnFileSystemExpandAll->Click += new System::EventHandler(this, btnFileSystemExpandAll_Click);
			// 
			...
			this->btnFileSystemCollapseAll->Click += new System::EventHandler(this, btnFileSystemCollapseAll_Click);
			// 
			// btnFileSystemMount
			// 
			...
			this->btnFileSystemMount->Click += new System::EventHandler(this, btnFileSystemMount_Click);
			// 
			// btnFileSystemSpace1
			// 
			...
			this->btnFileSystemAddGoto->Click += new System::EventHandler(this, btnFileSystemAddGoto_Click);
			// 
			// btnFileSystemSpace2
			// 
			...
			this->btnFileSystemDelete->Click += new System::EventHandler(this, btnFileSystemDelete_Click);
			// 
			// tabImage
			// 
			...
			this->tabImage->Size = System::Drawing::Size(192, 490);
			...
			this->grpImage->Size = System::Drawing::Size(176, 224);
			...
			this->trkHDRGamma->Size = System::Drawing::Size(112, 16);
			this->trkHDRGamma->TabIndex = 14;
			this->trkHDRGamma->TickFrequency = 160;
			this->trkHDRGamma->ValueChanged += new System::EventHandler(this, trkHDRGamma_ValueChanged);
			// 
			// mnuHDR
			// 
			...
			this->btnHDRReset->Click += new System::EventHandler(this, btnHDRReset_Click);
			// 
			// lblHDRShift
			// 
			...
			this->trkHDRShift->Size = System::Drawing::Size(112, 16);
			this->trkHDRShift->TabIndex = 12;
			this->trkHDRShift->TickFrequency = 20;
			this->trkHDRShift->Value = 100;
			this->trkHDRShift->ValueChanged += new System::EventHandler(this, trkHDRShift_ValueChanged);
			// 
			// lblHDRKey
			// 
			...
			this->trkHDRKey->Size = System::Drawing::Size(112, 16);
			this->trkHDRKey->TabIndex = 9;
			this->trkHDRKey->TickFrequency = 80;
			this->trkHDRKey->ValueChanged += new System::EventHandler(this, trkHDRKey_ValueChanged);
			// 
			// lblSlice
			// 
			...
			this->numSlice->Size = System::Drawing::Size(112, 20);
			this->numSlice->TabIndex = 5;
			this->numSlice->ValueChanged += new System::EventHandler(this, numVTFFile_ValueChanged);
			// 
			// lblMipmap
			// 
			...
			this->numMipmap->Size = System::Drawing::Size(112, 20);
			this->numMipmap->TabIndex = 7;
			this->numMipmap->ValueChanged += new System::EventHandler(this, numVTFFile_ValueChanged);
			// 
			// numFace
			// 
			...
			this->numFace->Size = System::Drawing::Size(112, 20);
			this->numFace->TabIndex = 3;
			this->numFace->ValueChanged += new System::EventHandler(this, numVTFFile_ValueChanged);
			// 
			// lblFace
			// 
			...
			this->numFrame->Size = System::Drawing::Size(112, 20);
			this->numFrame->TabIndex = 1;
			this->numFrame->ValueChanged += new System::EventHandler(this, numVTFFile_ValueChanged);
			// 
			// lblFrame
			// 
			...
			this->btnAnimate->Size = System::Drawing::Size(112, 23);
			...
			this->grpFlags->Size = System::Drawing::Size(176, 240);
			...
			this->lstFlags->Size = System::Drawing::Size(160, 214);
			this->lstFlags->TabIndex = 3;
			this->lstFlags->ItemCheck += new System::Windows::Forms::ItemCheckEventHandler(this, lstFlags_ItemCheck);
			// 
			// tabInfo
			// 
			...
			this->tabInfo->Size = System::Drawing::Size(192, 490);
			...
			this->grpImageInfo->Size = System::Drawing::Size(176, 272);
			...
			this->lblImageSlices->Size = System::Drawing::Size(96, 23);
			...
			__mcTemp__17[1] = 0;
			__mcTemp__17[2] = 0;
			__mcTemp__17[3] = 131072;
			this->numImageBumpmapScale->Increment = System::Decimal(__mcTemp__17);
			this->numImageBumpmapScale->Location = System::Drawing::Point(72, 216);
			this->numImageBumpmapScale->Name = S"numImageBumpmapScale";
			this->numImageBumpmapScale->Size = System::Drawing::Size(96, 20);
			...
			this->numImageStartFrame->Size = System::Drawing::Size(96, 20);
			...
			this->lblImageReflectivity->Size = System::Drawing::Size(96, 23);
			...
			this->lblImageMipmaps->Size = System::Drawing::Size(96, 23);
			...
			this->lblImageFaces->Size = System::Drawing::Size(96, 23);
			...
			this->lblImageFrames->Size = System::Drawing::Size(96, 23);
			...
			this->lblImageFormat->Size = System::Drawing::Size(96, 23);
			...
			this->lblImageHeight->Size = System::Drawing::Size(96, 23);
			...
			this->lblImageWidth->Size = System::Drawing::Size(96, 23);
			...
			this->grpThumbnailInfo->Size = System::Drawing::Size(176, 104);
			...
			this->lblThumbnailFormat->Size = System::Drawing::Size(96, 23);
			...
			this->lblThumbnailHeight->Size = System::Drawing::Size(96, 23);
			...
			this->lblThumbnailWidth->Size = System::Drawing::Size(96, 23);
			...
			this->grpFileInfo->Size = System::Drawing::Size(176, 80);
			...
			this->lblFileSize->Size = System::Drawing::Size(96, 23);
			...
			this->lblFileVersion->Size = System::Drawing::Size(96, 23);
			...
			this->pnlMain->Location = System::Drawing::Point(219, 28);
			this->pnlMain->Name = S"pnlMain";
			this->pnlMain->Size = System::Drawing::Size(533, 535);
			this->pnlMain->TabIndex = 2;
			this->pnlMain->DragEnter += new System::Windows::Forms::DragEventHandler(this, Control_DragEnter);
			this->pnlMain->DragDrop += new System::Windows::Forms::DragEventHandler(this, Control_DragDrop);
			// 
			// picVTFFileBR
			// 
			...
			this->picVTFFileBR->DragEnter += new System::Windows::Forms::DragEventHandler(this, Control_DragEnter);
			this->picVTFFileBR->DragDrop += new System::Windows::Forms::DragEventHandler(this, Control_DragDrop);
			this->picVTFFileBR->MouseMove += new System::Windows::Forms::MouseEventHandler(this, picVTFFile_MouseMove);
			// 
			// mnuVTFFile
			// 
			...
			this->btnVTFFileZoomIn->Click += new System::EventHandler(this, btnVTFFileZoomIn_Click);
			// 
			// btnVTFFileZoomOut
			// 
			this->btnVTFFileZoomOut->Index = 1;
			this->btnVTFFileZoomOut->Text = S"Zoom &Out";
			this->btnVTFFileZoomOut->Click += new System::EventHandler(this, btnVTFFileZoomOut_Click);
			// 
			// btnVTFFileSpace1
			// 
			...
			this->btnVTFFileZoomReset->Click += new System::EventHandler(this, btnVTFFileZoomReset_Click);
			// 
			// btnVTFFileSpace2
			// 
			...
			this->btnVTFFileCopy->Click += new System::EventHandler(this, btnVTFFileCopy_Click);
			// 
			// picVTFFileBL
			// 
			...
			this->picVTFFileBL->DragEnter += new System::Windows::Forms::DragEventHandler(this, Control_DragEnter);
			this->picVTFFileBL->DragDrop += new System::Windows::Forms::DragEventHandler(this, Control_DragDrop);
			this->picVTFFileBL->MouseMove += new System::Windows::Forms::MouseEventHandler(this, picVTFFile_MouseMove);
			// 
			// picVTFFileTR
			// 
			...
			this->picVTFFileTR->DragEnter += new System::Windows::Forms::DragEventHandler(this, Control_DragEnter);
			this->picVTFFileTR->DragDrop += new System::Windows::Forms::DragEventHandler(this, Control_DragDrop);
			this->picVTFFileTR->MouseMove += new System::Windows::Forms::MouseEventHandler(this, picVTFFile_MouseMove);
			// 
			// picVTFFileTL
			// 
			...
			this->picVTFFileTL->DragEnter += new System::Windows::Forms::DragEventHandler(this, Control_DragEnter);
			this->picVTFFileTL->DragDrop += new System::Windows::Forms::DragEventHandler(this, Control_DragDrop);
			this->picVTFFileTL->MouseMove += new System::Windows::Forms::MouseEventHandler(this, picVTFFile_MouseMove);
			// 
			// txtVMTFile
			// 
			...
			this->txtVMTFile->Size = System::Drawing::Size(533, 535);
			this->txtVMTFile->TabIndex = 5;
			this->txtVMTFile->Text = S"";
			this->txtVMTFile->Visible = false;
			this->txtVMTFile->WordWrap = false;
			this->txtVMTFile->TextChanged += new System::EventHandler(this, txtVMTFile_TextChanged);
			...
			this->btnVMTFileUndo->Click += new System::EventHandler(this, btnVMTFileUndo_Click);
			// 
			// btnVMTFileSpace1
			// 
			...
			this->btnVMTFileCut->Click += new System::EventHandler(this, btnVMTFileCut_Click);
			// 
			// btnVMTFileCopy
			// 
			...
			this->btnVMTFileCopy->Click += new System::EventHandler(this, btnVMTFileCopy_Click);
			// 
			// btnVMTFilePaste
			// 
			...
			this->btnVMTFilePaste->Click += new System::EventHandler(this, btnVMTFilePaste_Click);
			// 
			// btnVMTFileDelete
			// 
			...
			this->btnVMTFileDelete->Click += new System::EventHandler(this, btnVMTFileDelete_Click);
			// 
			// btnVMTFileSpace2
			// 
			...
			this->btnVMTFileSelectAll->Click += new System::EventHandler(this, btnVMTFileSelectAll_Click);
			// 
			// btnVMTFileSpace3
			// 
			...
			this->btnVMTFileValidate->Click += new System::EventHandler(this, btnVMTFileValidate_Click);
			// 
			// dlgImportFile
			// 
			...
			// dlgExportFile
			// 
			this->dlgExportFile->Filter = S"BMP Files (*.bmp)|*.bmp|JPEG Files (*.jpg;*.jpeg)|*.jpg;*.jpeg|TGA Files (*.tga)|" 
				S"*.tga";
			this->dlgExportFile->FilterIndex = 3;
			this->dlgExportFile->Title = S"Export File";
			// 
			// barTool
			// 
			System::Windows::Forms::ToolBarButton* __mcTemp__21[] = new System::Windows::Forms::ToolBarButton*[6];
			__mcTemp__21[0] = this->btnToolImport;
			__mcTemp__21[1] = this->btnToolOpen;
			__mcTemp__21[2] = this->btnToolSave;
			__mcTemp__21[3] = this->btnSeparator1;
			__mcTemp__21[4] = this->btnToolCopy;
			__mcTemp__21[5] = this->btnToolPaste;
			this->barTool->Buttons->AddRange(__mcTemp__21);
			...
			this->barTool->ButtonClick += new System::Windows::Forms::ToolBarButtonClickEventHandler(this, barTool_ButtonClick);
			// 
			// btnToolImport
			// 
			...
			this->splSidebar->Location = System::Drawing::Point(216, 28);
			...
			this->splSidebar->SplitterMoved += new System::Windows::Forms::SplitterEventHandler(this, splSidebar_SplitterMoved);
			// 
			...
			this->Text = S"VTFEdit";
			this->Resize += new System::EventHandler(this, CVTFEdit_Resize);
			this->Closing += new System::ComponentModel::CancelEventHandler(this, CVTFEdit_Closing);
			this->Load += new System::EventHandler(this, CVTFEdit_Load);
			this->Move += new System::EventHandler(this, CVTFEdit_Move);
		...
		protected:
			void OnCreated(Object* s, System::IO::FileSystemEventArgs* e)
			{
				...
				else if(System::IO::File::Exists(e->FullPath))
				{
					...
					if(!((SubFileInfo->Attributes & System::IO::FileAttributes::System) || (SubFileInfo->Attributes & System::IO::FileAttributes::Hidden)))
					{
						if(String::Compare(SubFileInfo->Extension, S".bsp", true) == 0 || String::Compare(SubFileInfo->Extension, S".gcf", true) == 0 || String::Compare(SubFileInfo->Extension, S".pak", true) == 0 || String::Compare(SubFileInfo->Extension, S".wad", true) == 0)
						{
		...
		public: __property void set_FileName(System::String *sFileName)
		{
			...
			if(sFileName)
			{
				...
				{
					this->Text = String::Concat(sFileName->Substring(sFileName->LastIndexOf('\\') + 1), S" - VTFEdit");
				}
				else
				{
					this->Text = String::Concat(sFileName, S" - VTFEdit");
				}
			}
			else
			{
				if(this->VTFFile)
				{
					this->Text = S"untitled.vtf - VTFEdit";
				}
				else if(this->VMTFile)
				{
					this->Text = S"untitled.vmt - VTFEdit";
				}
				else
				{
					this->Text = S"VTFEdit";
		...
		private: System::Void CVTFEdit_Load(System::Object *  sender, System::EventArgs *  e)
		{
			...
			this->txtVMTFile->DragEnter += new System::Windows::Forms::DragEventHandler(this, Control_DragEnter);
			this->txtVMTFile->DragDrop += new System::Windows::Forms::DragEventHandler(this, Control_DragDrop);
			...
			btnHDRReset_Click(this, System::EventArgs::Empty);

			// Restore options.
			this->BackupForm();
			bool bHasConfig = this->ReadConfigFile(String::Concat(Application::StartupPath, S"\\VTFEdit.ini"));
			this->RestoreForm();
			...
			if(System::Threading::Thread::CurrentThread->ApartmentState == System::Threading::ApartmentState::STA)
			{
				...
				{
					this->hWndNewViewer = SetClipboardViewer((HWND)this->Handle.ToInt32());
				}
			}
			else
			{	// Set intitial clipboard state.
		...
		private: System::Void CVTFEdit_Closing(System::Object *  sender, System::ComponentModel::CancelEventArgs *  e)
		{
			...
			//ChangeClipboardChain((HWND)this->Handle.ToInt32(), this->hWndNewViewer);

			this->WriteConfigFile(String::Concat(Application::StartupPath, S"\\VTFEdit.ini"));
		}
		...
		protected: System::Void WndProc(Message *e)
		{
			if(System::Threading::Thread::CurrentThread->ApartmentState == System::Threading::ApartmentState::STA)
			{
				...
				case WM_CHANGECBCHAIN:
					...
					this->hWndNewViewer = (HWND)e->LParam.ToInt32();

					if(this->hWndNewViewer != 0)
					{
						SendMessage(this->hWndNewViewer, e->Msg, (WPARAM)e->WParam.ToInt32(), (LPARAM)e->LParam.ToInt32());
					}
		...
		private: void SetVTFFile(VTFLib::CVTFFile *VTFFile)
		{
			...
			this->lstFlags->Items->Add(S"No Compression (Format Specific)", uiFlags & TEXTUREFLAGS_NOCOMPRESS);
			...
			this->lstFlags->Items->Add(S"One Over Mipmap Level In Alpha", uiFlags & TEXTUREFLAGS_ONEOVERMIPLEVELINALPHA);
			this->lstFlags->Items->Add(S"Premultiply Color By One Over Mipmap Level", uiFlags & TEXTUREFLAGS_PREMULTCOLORBYONEOVERMIPLEVEL);
			this->lstFlags->Items->Add(S"Normal Map To Du/Dv", uiFlags & TEXTUREFLAGS_NORMALTODUDV);
			this->lstFlags->Items->Add(S"Alpha Hates Mipmap Generation", uiFlags & TEXTUREFLAGS_ALPHATESTMIPGENERATION);
			this->lstFlags->Items->Add(S"No Depth Buffer", uiFlags & TEXTUREFLAGS_NODEPTHBUFFER);
			this->lstFlags->Items->Add(S"Nice Filter", uiFlags & TEXTUREFLAGS_NICEFILTERED);
			...
			this->lblFileSize->Text = String::Concat(((float)VTFFile->GetSize() / 1024.0f).ToString(S"#,##0.00"), S" KB");
			...
			this->lblImageReflectivity->Text = String::Concat(sX.ToString(S"0.00"), S", ", sY.ToString(S"0.00"), S", ", sZ.ToString(S"0.00"));
		...
		private: bool GetVMTFile()
		{
			...
			if (!bResult)
			{
				MessageBox::Show(String::Concat("Error parsing VMT:\n\n", new String(vlGetLastError())), "VTFEdit", MessageBoxButtons::OK, MessageBoxIcon::Error);
			}
		...
		private: void Open(String *sFileName, bool bTemp)
		{
			...
			char cPath[512];
			this->StringToCharPointer(sFileName, cPath, 512);
			...
			else if(sFileName->ToLower()->EndsWith(".vmt"))
			{
				...
				if(VMTFile->Load(cPath))
				{
					...
					catch(Exception *e)
					{
						...
						MessageBox::Show(String::Concat("Error loading VMT texture:\n\n", e->Message), "VTFEdit", MessageBoxButtons::OK, MessageBoxIcon::Error);
						return;
					}
		...
		private: void Import(String *sFileNames __gc[])
		{
			...
			{
				this->StringToCharPointer(static_cast<String *>(sFileNames->get_Item(i)), cPath, 512);
				...
				if(ilLoadImage(cPath))
				{
					...
					if(ilConvertImage(IL_RGBA, IL_UNSIGNED_BYTE))
					{
						...
						else
						{
							if(uiWidth != (vlUInt)ilGetInteger(IL_IMAGE_WIDTH) || uiHeight != (vlUInt)ilGetInteger(IL_IMAGE_HEIGHT))
							{
								...
								MessageBox::Show("Error loading image:\n\nAll frames and faces must be the same size.", "VTFEdit", MessageBoxButtons::OK, MessageBoxIcon::Error);
					...
					else
					{
						...
						MessageBox::Show("Error converting image.", "VTFEdit", MessageBoxButtons::OK, MessageBoxIcon::Error);
				...
				else
				{
					...
					MessageBox::Show("Error loading image.", "VTFEdit", MessageBoxButtons::OK, MessageBoxIcon::Error);
			...
			if(VTFFile != 0)
			{
				...
				// Create the .vtf file.
				if(VTFFile->Create(uiWidth, uiHeight, uiFrames, uiFaces, uiSlices, lpImageData, VTFCreateOptions))
				{
					this->SetVTFFile(VTFFile);
		...
		private: void Export(String *sFileName)
		{
			...
			{
				MessageBox::Show("Error saving image.", "VTFEdit", MessageBoxButtons::OK, MessageBoxIcon::Error);
			}
		...
		private: System::Void btnPaste_Click(System::Object *  sender, System::EventArgs *  e)
		{
			if(System::Threading::Thread::CurrentThread->ApartmentState == System::Threading::ApartmentState::STA)
			{
				...
				// Create the .vtf file.
				if(VTFFile->Create(uiWidth, uiHeight, lpImageData, VTFCreateOptions))
				{
					this->SetVTFFile(VTFFile);
		...
		private: System::Void lstFlags_ItemCheck(System::Object *  sender, System::Windows::Forms::ItemCheckEventArgs *  e)
		{
			...
			if(e->Index == 6 || e->Index == 12 || e->Index == 13 || e->Index == 14)
			{
		...
		{
			int iX = (int)((float)e->X / this->fImageScale);
			int iY = (int)((float)e->Y / this->fImageScale);
		...
		private: System::Void EnableVMTContextMenuItems()
		{
			...
			column = SendMessage((HWND)this->txtVMTFile->Handle.ToInt32(), EM_LINEINDEX, line, 0);
		...
		private: System::Void btnVMTFileValidate_Click(System::Object *  sender, System::EventArgs *  e)
		{
			char *cText = (char *)System::Runtime::InteropServices::Marshal::StringToHGlobalAnsi(this->txtVMTFile->Text).ToPointer();
			if(VMTFile->Load( cText, this->txtVMTFile->Text->Length))
			{
				MessageBox::Show(S"VMT validation successful.", "VTFEdit", MessageBoxButtons::OK, MessageBoxIcon::Information);
			}
			else
			{
		...
		private: System::Void btnFileSystemDelete_Click(System::Object *  sender, System::EventArgs *  e)
		{
			...
			if(this->treFileSystem->SelectedNode->GetType()->Equals(__typeof(CDirectoryFileSystemTreeNode)))
			{
				...
				try
				{
					if(MessageBox::Show(String::Concat(S"Are you sure you want to permanently delete '", Node->Text, S"'?"), S"VTFEdit", System::Windows::Forms::MessageBoxButtons::YesNo, System::Windows::Forms::MessageBoxIcon::Question) == System::Windows::Forms::DialogResult::Yes)
					{
				...
				{
					MessageBox::Show(String::Concat(S"Error deleting '", Node->Text, S"':\n\n", e->Message), S"VTFEdit", System::Windows::Forms::MessageBoxButtons::OK, System::Windows::Forms::MessageBoxIcon::Error);
				}
			}
		}
		...
		//
		// StringToCharPointer()
		// Copies sString to the cString buffer.
		//
		private: void StringToCharPointer(String *sString, char *cString, int iLength)
		{
			char *cTemp;

			cTemp = (char *)(System::Runtime::InteropServices::Marshal::StringToHGlobalAnsi(sString)).ToPointer();

			strncpy(cString, cTemp, iLength);
		...
		private: String *GetImageFormatString(VTFImageFormat ImageFormat)
		{
			...
			case IMAGE_FORMAT_RGB888_BLUESCREEN:
				return S"RGB888_BLUESCREEN";
			case IMAGE_FORMAT_BGR888_BLUESCREEN:
				return S"BGR888_BLUESCREEN";
			...
			case IMAGE_FORMAT_RGBA16161616F:
				return S"RGBA16161616F";
			case IMAGE_FORMAT_RGBA16161616:
				return S"RGBA16161616S";
		...
		private: bool WriteConfigFile(String *sConfigFile)
		{
			...
			//{
				...
				ConfigFile->WriteLine(String::Concat("Forms.BatchConvert.Filter = ", this->BatchConvert->Filter));
			...
			try
			{
				...
				while((sLine = ConfigFile->ReadLine()) != 0)
				{
					...
					try
					{
						...
						else if(String::Compare(sArg, S"Forms.BatchConvert.Filter", true) == 0)
						{
							this->BatchConvert->Filter = sVal;
						}
