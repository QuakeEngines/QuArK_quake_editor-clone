...
namespace VTFEdit
{
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			System::Resources::ResourceManager *  resources = new System::Resources::ResourceManager(__typeof(VTFEdit::CVTFOptions));
			...
			this->grpMiscellaneous->Location = System::Drawing::Point(8, 104);
			...
			this->chkNormalMap->CheckedChanged += new System::EventHandler(this, chkNormalMap_CheckedChanged);
			// 
			// cboTextureType
			// 
			...
			this->cboTextureType->SelectedIndexChanged += new System::EventHandler(this, cboTextureType_SelectedIndexChanged);
			// 
			// lblTextureType
			// 
			...
			this->chkMipmaps->CheckedChanged += new System::EventHandler(this, chkMipmaps_CheckedChanged);
			// 
			// cboFormat
			// 
			...
			this->chkGammaCorrection->CheckedChanged += new System::EventHandler(this, chkGammaCorrection_CheckedChanged);
			// 
			// grpGeneralOptions
			// 
			...
			this->chkResizeClamp->CheckedChanged += new System::EventHandler(this, chkResizeClamp_CheckedChanged);
			// 
			// cboResizeMethod
			// 
			...
			__mcTemp__26[1] = 0;
			__mcTemp__26[2] = 0;
			__mcTemp__26[3] = 196608;
			this->numLuminanceWeightsR->Increment = System::Decimal(__mcTemp__26);
			...
			__mcTemp__27[2] = 0;
			__mcTemp__27[3] = 0;
			this->numLuminanceWeightsR->Maximum = System::Decimal(__mcTemp__27);
			...
			__mcTemp__28[1] = 0;
			__mcTemp__28[2] = 0;
			__mcTemp__28[3] = 196608;
			this->numLuminanceWeightsG->Increment = System::Decimal(__mcTemp__28);
			...
			__mcTemp__29[2] = 0;
			__mcTemp__29[3] = 0;
			this->numLuminanceWeightsG->Maximum = System::Decimal(__mcTemp__29);
			...
			__mcTemp__30[1] = 0;
			__mcTemp__30[2] = 0;
			__mcTemp__30[3] = 196608;
			this->numLuminanceWeightsB->Increment = System::Decimal(__mcTemp__30);
			...
			__mcTemp__31[2] = 0;
			__mcTemp__31[3] = 0;
			this->numLuminanceWeightsB->Maximum = System::Decimal(__mcTemp__31);
			...
			this->grpLuminanceWeights->TabIndex = 3;
			...
			this->grpUnsharpenMaskOptions->TabIndex = 4;
			...
			__mcTemp__32[1] = 0;
			__mcTemp__32[2] = 0;
			__mcTemp__32[3] = 131072;
			this->numUnsharpenMaskThreshold->Increment = System::Decimal(__mcTemp__32);
			...
			__mcTemp__33[2] = 0;
			__mcTemp__33[3] = 0;
			this->numUnsharpenMaskThreshold->Maximum = System::Decimal(__mcTemp__33);
			...
			this->grpDXTCompression->Location = System::Drawing::Point(8, 208);
			...
			this->grpXSharpenOptions->TabIndex = 5;
			...
			__mcTemp__34[2] = 0;
			__mcTemp__34[3] = 0;
			this->numXSharpenThreshold->Maximum = System::Decimal(__mcTemp__34);
			System::Int32 __mcTemp__35[] = new System::Int32[4];
			__mcTemp__35[0] = 1;
			__mcTemp__35[1] = 0;
			__mcTemp__35[2] = 0;
			__mcTemp__35[3] = 0;
			this->numXSharpenThreshold->Minimum = System::Decimal(__mcTemp__35);
			...
			__mcTemp__36[2] = 0;
			__mcTemp__36[3] = 0;
			this->numXSharpenThreshold->Value = System::Decimal(__mcTemp__36);
			// 
			...
			__mcTemp__37[2] = 0;
			__mcTemp__37[3] = 0;
			this->numXSharpenStrength->Maximum = System::Decimal(__mcTemp__37);
			System::Int32 __mcTemp__38[] = new System::Int32[4];
			__mcTemp__38[0] = 1;
			__mcTemp__38[1] = 0;
			__mcTemp__38[2] = 0;
			__mcTemp__38[3] = 0;
			this->numXSharpenStrength->Minimum = System::Decimal(__mcTemp__38);
			...
			__mcTemp__39[2] = 0;
			__mcTemp__39[3] = 0;
			this->numXSharpenStrength->Value = System::Decimal(__mcTemp__39);
			// 
			// lblXSharpenStrength
			// 
			...
			this->Load += new System::EventHandler(this, CVTFOptions_Load);
		...
		{
			this->numNormalScale->Value = Convert::ToDecimal(sNormalScale);
		}
		...
		{
			this->numGammaCorrection->Value = Convert::ToDecimal(sGammaCorrection);
		}
		...
		{
			this->numLuminanceWeightsR->Value = Convert::ToDecimal(sLuminanceWeightR);
		}
		...
		{
			this->numLuminanceWeightsG->Value = Convert::ToDecimal(sLuminanceWeightG);
		}
		...
		{
			this->numLuminanceWeightsB->Value = Convert::ToDecimal(sLuminanceWeightB);
		}
		...
		{
			this->numUnsharpenMaskRadius->Value = Convert::ToDecimal(sUnsharpenMaskRadius);
		}
		...
		{
			this->numUnsharpenMaskAmount->Value = Convert::ToDecimal(sUnsharpenMaskAmount);
		}
		...
		{
			this->numUnsharpenMaskThreshold->Value = Convert::ToDecimal(sUnsharpenMaskThreshold);
		}
		...
		{
			this->numXSharpenStrength->Value = Convert::ToDecimal(sXSharpenStrength);
		}
		...
		{
			this->numXSharpenThreshold->Value = Convert::ToDecimal(sXSharpenThreshold);
		}
