...
namespace VTFEdit
{
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->btnWADFileBrowse->Click += new System::EventHandler(this, btnWADFileBrowse_Click);
			// 
			// txtWADFile
			// 
			...
			this->txtWADFile->TextChanged += new System::EventHandler(this, Path_TextChanged);
			// 
			// lblWADFile
			// 
			...
			this->Closing += new System::ComponentModel::CancelEventHandler(this, CWADConvert_Closing);
			this->Load += new System::EventHandler(this, CWADConvert_Load);
		...
		private: System::Void CWADConvert_Closing(System::Object *  sender, System::ComponentModel::CancelEventArgs *  e)
		{
		...
		private: System::Void btnConvert_Click(System::Object *  sender, System::EventArgs *  e)
		{
			...
			if(!WADFile.Open(cWADFile, HL_MODE_READ))
			{
				...
				MessageBox::Show(String::Concat("Error loading WAD file:\n\n", new String(hlGetString(HL_ERROR_LONG_FORMATED))), "VTFEdit", MessageBoxButtons::OK, MessageBoxIcon::Error);
				return;
			}
			...
			for(DWORD i = 0; i < Root->GetCount(); i++)
			{
				...
				if(WADFile.GetImageSize(File, dwPaletteSize, dwPixelSize))
				{
					...
					if(WADFile.GetImageData(File, dwWidth, dwHeight, lpPaletteData, lpPixelData))
					{
						...
						if(VTFFile.Create(dwWidth, dwHeight, lpImageData, VTFCreateOptions))
						{
