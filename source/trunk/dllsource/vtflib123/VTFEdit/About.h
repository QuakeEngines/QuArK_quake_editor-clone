...
namespace VTFEdit
{
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->lnkWunderboy->LinkClicked += new System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, lnkWunderboy_LinkClicked);
			// 
			// lblLines
			// 
			...
			this->lblLines->Text = S"Lines: 8,068";
			// 
			// lblLanguage
			// 
			...
			this->lblDate->Text = S"Date: 11/16/2006";
			// 
			// lblAuthor
			// 
			...
			this->lblVTFEditVersion->Text = S"VTFEdit Version: 1.2.2";
			// 
			// lnkNemsTools
			// 
			...
			this->lnkNemsTools->LinkClicked += new System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, lnkNemsTools_LinkClicked);
			// 
			// picIcon
			// 
