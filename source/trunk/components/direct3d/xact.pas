...
//  HResult error code
////
function XACT3DInitialize(SpeakerChannelMask: LongWord; const pEngine: IXACTEngine; out X3DInstance: TX3DAudioHandle): HRESULT; cdecl;
...
function XACT3DInitialize(SpeakerChannelMask: LongWord; const pEngine: IXACTEngine;
  out X3DInstance: TX3DAudioHandle): HRESULT; cdecl;
var
