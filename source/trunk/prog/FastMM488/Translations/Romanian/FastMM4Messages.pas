...
const
  ...
  {Stack trace Message}
  CurrentStackTraceMsg = #13#10#13#10'Stiva curenta trimite la urmatoarea eroare (adresa retur): ';
  {Memory dump message}
  ...
  StackTraceAtPrevAllocMsg = #13#10#13#10'Urmarire stiva - blocul a dost deja alocat (adresa retur):';
  StackTraceAtAllocMsg = #13#10#13#10'Urmarire stiva - blocu a fost alocat (adresa retur):';
  ...
  StackTraceAtFreeMsg = #13#10#13#10'Urmarire stiva - cand blocul a fost eliberat (adresa retur):';
  ...
  StackTraceAtObjectAllocMsg = #13#10#13#10'Urmarire stiva - Cand obiectul a fost alocat (adresa retur):';
  StackTraceAtObjectFreeMsg = #13#10#13#10'Urmarire stiva - Cand obiectul a fost eliberat (adresa retur):';
