...
namespace VTFEdit
{
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->lblLines->Text = S"Lines: 8,652";
			// 
			// lblLanguage
			// 
			...
			this->lblDate->Text = S"Date: 9/14/2007";
			// 
			// lblAuthor
			// 
			...
			this->lblVTFEditVersion->Text = S"VTFEdit Version: 1.2.4";
			// 
			// lnkNemsTools
			// 
			...
			this->Load += new System::EventHandler(this, &CAbout::CAbout_Load);
