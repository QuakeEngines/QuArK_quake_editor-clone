...
{
	return new CPrimitiveFileMapping(this->szFileName);
}
...
BOOL CPrimitiveFileMapping::Map()
{
	...
	// Create file.
	this->hFile = CreateFile(this->szFileName, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
