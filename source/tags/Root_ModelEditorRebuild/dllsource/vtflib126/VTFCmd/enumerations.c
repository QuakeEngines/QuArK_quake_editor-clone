...
VTFImageFlag StringToImageFlag(const vlChar *cString)
{
	...
	else if(stricmp(cString, "ONEOVERMIPLEVELINALPHA") == 0)
	{
		return TEXTUREFLAGS_ONEOVERMIPLEVELINALPHA;
	}
	else if(stricmp(cString, "PREMULTCOLORBYONEOVERMIPLEVEL") == 0)
	{
		return TEXTUREFLAGS_PREMULTCOLORBYONEOVERMIPLEVEL;
	}
	else if(stricmp(cString, "NORMALTODUDV") == 0)
	{
		return TEXTUREFLAGS_NORMALTODUDV;
	}
	else if(stricmp(cString, "ALPHATESTMIPGENERATION") == 0)
	{
		return TEXTUREFLAGS_ALPHATESTMIPGENERATION;
	}
	else if(stricmp(cString, "NODEPTHBUFFER") == 0)
	{
		return TEXTUREFLAGS_NODEPTHBUFFER;
	}
	else if(stricmp(cString, "NICEFILTERED") == 0)
	{
		return TEXTUREFLAGS_NICEFILTERED;
	}
	...
	else if(stricmp(cString, "UNUSED") == 0)
	{
		return TEXTUREFLAGS_UNUSED;
	}
	else if(stricmp(cString, "UNFILTERABLE_OK") == 0)
	{
		return TEXTUREFLAGS_UNFILTERABLE_OK;
	}
	else if(stricmp(cString, "BORDER") == 0)
	{
		return TEXTUREFLAGS_BORDER;
	}
	else if(stricmp(cString, "SPECVAR_RED") == 0)
	{
		return TEXTUREFLAGS_SPECVAR_RED;
	}
	else if(stricmp(cString, "SPECVAR_ALPHA") == 0)
	{
		return TEXTUREFLAGS_SPECVAR_ALPHA;
	}
	else
	{
