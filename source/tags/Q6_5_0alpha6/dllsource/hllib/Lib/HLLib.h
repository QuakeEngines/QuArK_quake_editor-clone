...
public:
	...
	BOOL Open(CMapping *Mapping, LPCSTR szFileName = 0);
	virtual void Close();
...
public:
	...
	BOOL GetImageSize(CDirectoryFile *File, DWORD &dwPaletteSize, DWORD &dwPixelSize);
	BOOL GetImageData(CDirectoryFile *File, DWORD &dwWidth, DWORD &dwHeight, LPBYTE lpPaletteData, LPBYTE lpPixelData);

	BOOL GetImageSize(CDirectoryFile *File, DWORD &dwSize);
	BOOL GetImageData(CDirectoryFile *File, DWORD &dwWidth, DWORD &dwHeight, LPBYTE lpData);
