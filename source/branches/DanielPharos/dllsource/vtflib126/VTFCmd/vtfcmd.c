...
void PrintUsage(const vlChar *lpError, ...)
{
	...
	if(bHelp)
	{
		...
		Print("         DEPTHRENDERTARGET, NODEBUGOVERRIDE, SINGLECOPY,\n");
		Print("         ONEOVERMIPLEVELINALPHA, PREMULTCOLORBYONEOVERMIPLEVEL, NORMALTODUDV,\n");
		Print("         ALPHATESTMIPGENERATION, NODEPTHBUFFER, NICEFILTERED, CLAMPU,\n");
		Print("         VERTEXTEXTURE, UNUSED, UNFILTERABLE_OK, BORDER, SPECVAR_RED,\n");
		Print("         SPECVAR_ALPHA\n");
