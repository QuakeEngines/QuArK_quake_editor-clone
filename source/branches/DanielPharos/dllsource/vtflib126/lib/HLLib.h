...
#define HL_VERSION_NUMBER	207
#define HL_VERSION_STRING	"2.0.7"
...
namespace HLLib
{
	...
	namespace Mapping
	{
		...
		public:
			...
			hlBool Commit(CView &View, hlUInt uiOffset, hlUInt uiLength);
		...
		private:
			...
			virtual hlBool CommitInternal(CView &View, hlUInt uiOffset, hlUInt uiLength);
		};
