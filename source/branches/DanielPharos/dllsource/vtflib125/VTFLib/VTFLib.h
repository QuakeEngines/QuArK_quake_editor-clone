...
/*!
	\mainpage VTFLib - Copyright &copy; 2005 Neil Jedrzejewski & Ryan Gregg
...
//! Define this to remove the NVDXT library from VTFLib (will limit VTFLib's functionality).
#define USE_NVDXT 1
...
#define VL_VERSION			125			//!< VTFLib version as integer
#define VL_VERSION_STRING	"1.2.5"		//!< VTFLib version as string
