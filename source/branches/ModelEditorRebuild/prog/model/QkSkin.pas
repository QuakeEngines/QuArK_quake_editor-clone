...
uses
  QkObjects, QkFileObjects, QkMdlObject, QkForm, QkImages, Python, Game;
...
function QSkin.IsAllowedParent(Parent: QObject) : Boolean;
begin
...
class function QSkin.TypeInfo: String;
begin
 TypeInfo:='.pcx';
end;
