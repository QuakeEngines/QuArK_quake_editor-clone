...
#define VTF_MINOR_VERSION	3		//!< VTF minor version number
...
typedef enum tagVTFImageFormat
{
	...
	IMAGE_FORMAT_I32F,						//!<  = Luminance - 32 bpp
...
typedef enum tagVTFImageFlag
{
	...
	TEXTUREFLAGS_UNUSED							= 0x08000000,
	TEXTUREFLAGS_UNFILTERABLE_OK				= 0x10000000,
	TEXTUREFLAGS_BORDER							= 0x20000000,
	TEXTUREFLAGS_SPECVAR_RED					= 0x40000000,
	TEXTUREFLAGS_SPECVAR_ALPHA					= 0x80000000,
	TEXTUREFLAGS_LAST							= 0x80000000,
	TEXTUREFLAGS_COUNT							= 32
} VTFImageFlag;
...
struct SVTFHeader : public SVTFHeader_73_A
{
	vlByte				Padding3[8];
